<%-- 
    Document   : cart
    Created on : 24 Nov, 2022, 10:04:12 PM
    ...
    <div id="mobile-menu-offcanvas" class="offcanvas offcanvas-rightside offcanvas-mobile-menu-section">
        ...
        <div class="offcanvas-mobile-menu-wrapper">
            ...
            <div class="mobile-contact-info">
                <div class="logo">
                    <a href="index.jsp"><img src="assets/images/logo/logo_white.png" alt=""></a>
                </div>
                            ...
                            <div class="table_page table-responsive">
                                ...
                                try{
                                    Class.forName("com.mysql.jdbc.Driver");
                                     ...
                                     PreparedStatement pst = conn.prepareStatement("select * from cart where uemail=?");
                                     pst.setString(1, mail);
                                     ResultSet rs = pst.executeQuery();
                                        
                                        while(rs.next()){
                                 String total=rs.getString("price");
                                              int tprice=Integer.parseInt(rs.getString("price"));
                                    ...
                                    <tbody>
                                        <!-- Start Cart Single Item-->
                                                ...
                                                <tr>
                                            <td class="product_remove"><a href="delete.jsp?d=<%= rs.getString("catid")%>"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                            <td class="product_thumb"><a href="product-details-default.html"><img
                                                        src="assets/images/product/default/home-1/<%= rs.getString("productphoto")%>"
                                                        alt=""></a></td>
                                            <td class="product_name"><a href="product-details-default.html"><%= rs.getString("productname")%></a></td>
                                            <td class="product-price">$<%= rs.getString("price")%></td>
                                            <td class="product_quantity"><label>Quantity</label> <input min="1"
                                                    max="100" value="1" type="number"></td>
                                            <td class="product_total">$<%= rs.getString("price")%></td>
                        ...
                        <div class="coupon_code right" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="coupon_inner">
                                <div class="cart_subtotal">
                                    <p>Subtotal</p>
                                    <p class="cart_amount">$<% out.print(sum); %></p>
                                </div>
                                    <% 
                                        int ship=255;
                                      int total=sum+ship;
                                ...
                                <div class="cart_subtotal">
                                    <p>Total</p>
                                    <p class="cart_amount">$<% out.print(total); %>.00</p>
                                    
                                </div>
                                <div class="checkout_btn">
                                    <a href="#" class="btn btn-md btn-golden"><input type="submit" name="btn" value="Proceed to Checkout" style="color: white"/></a>
                                </div>
