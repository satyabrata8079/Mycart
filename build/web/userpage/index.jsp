<%-- 
    Document   : index
    Created on : 23 Nov, 2022, 1:16:28 AM
...
<body>
        ...
        <div class="offcanvas-mobile-menu-wrapper">
            ...
            <div class="mobile-contact-info">
                ...
                <address class="address">
                    ...
                    <span>Email: <% out.print("   "+ session.getAttribute("email"));%></span>
                </address>
    ...
    <div id="offcanvas-add-cart" class="offcanvas offcanvas-rightside offcanvas-add-cart-section">
        ...
        <div class="offcanvas-add-cart-wrapper">
            ...
            <ul class="offcanvas-cart-action-button">
                <li><a href="cart.jsp" class="btn btn-block btn-golden">View Cart</a></li>
    ...
    <div class="product-default-slider-section section-top-gap-100 section-fluid">
        ...
        <!-- Start Section Content Text Area -->
                ...
                %>
                <form action="addacrtt.jsp" method="post">
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="product-details-default.html" class="image-link">
                                                ...
                                                <img src="assets/images/product/default/home-1/<%= rs.getString("productphoto")%>" alt="">
                                                <input type="hidden" name="photo" value="<%= rs.getString("productphoto")%>">
                                            </a>
                                            <div class="action-link">
                                                <div class="action-link-left">
<!--                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#modalAddcart">Add to Cart</a>-->
<input type="submit" name="btn" value="Add to cart" style="color: white"/>Add to cart
                                                </div>
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><input type="hidden" name="pname" value="<%= rs.getString("productname")%>"/><%= rs.getString("productname")%></h6>
                                            ...
                                            <div class="content-right">
                                                <span class="price" name="price"><input type="hidden" name="price" value="<%= rs.getString("productcolprice")%>"/>$<%= rs.getString("productcolprice")%></span>
                                            </div>
