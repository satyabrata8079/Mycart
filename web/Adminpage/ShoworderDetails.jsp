...
<head>
    ...
    <link href="css/showdetails.css" rel="stylesheet" media="all">
    <!--modal-->
      ...
      <table class="order-table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><%= rs.getString("satatus") %></td>
                <td colspan="3">
                    <a href="viewOrder.jsp?oid=<%= rs.getString("oid") %>" class="confirm-button btn-primary">View Details</a>
                    <a href="confirmOrder.jsp?oid=<%= rs.getString("oid") %>" class="confirm-button btn-success">Confirm</a>
                    <a href="cancelOrder.jsp?oid=<%= rs.getString("oid") %>" class="confirm-button btn-danger">Cancel</a>
                </td>
            </tr>
